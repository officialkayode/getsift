  ...
  return (
    <section className="container px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-xl md:text-2xl font-bold mb-8 text-center">The Challenge: Delayed Resolution & Lost Knowledge</h2>
        
        <div className="space-y-6 mb-12">
          <p className="text-foreground/70 text-lg">Reliability and Support Engineers struggle with:</p>
          <ul className="list-disc pl-6 space-y-3 text-foreground/70 text-lg">
