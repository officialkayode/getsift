export const LogoStrip = () => {
  return <section className="py-12 md:py-16 bg-white border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-6">
        <p className="text-center text-sm text-gray-500 mb-8 font-medium tracking-wide uppercase">BUILT BY EXPERTS FROM</p>
        
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
          {/* Meta */}
          <div className="grayscale hover:grayscale-0 transition-all duration-300 opacity-60 hover:opacity-100">
            <img src="/meta-logo.png" alt="Meta" className="h-6 md:h-8 w-auto object-contain" />
          </div>
