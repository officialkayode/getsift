          ...
          <div className="text-center max-w-3xl mx-auto font-garamond">
            <Tooltip>
              <TooltipTrigger asChild>
                <h1 className="text-3xl sm:text-4xl md:text-5xl tracking-wide mb-4 sm:mb-6 text-white font-mono font-normal lg:text-4xl">The secure context layer for humans and agents at work</h1>
              </TooltipTrigger>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
              ...
              <Link to="/learn-more" className={`${isMobile ? 'w-1/2' : 'w-full sm:w-auto'}`}>
                <Button variant="outline" className="w-full bg-transparent border-gray-500 text-white hover:bg-gray-800 font-garamond text-xs sm:text-sm py-1 px-3 sm:py-2 sm:px-4 h-auto sm:h-10">
